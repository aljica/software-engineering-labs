...
class ViewControl extends JFrame /*implements ActionListener*/ {
  ...
  public static void main(String[] u) {
    Boardgame game = new TicTacToe(); // See https://stackoverflow.com/questions/16750772/instantiating-interfaces-in-java
    //Boardgame game = null; // temporarily
    new ViewControl(game, 3); // For testing purposes.
  }
