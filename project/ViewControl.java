...
class ViewControl extends JFrame {
  ...
  public static void main(String[] u) {
    Boardgame game = new Chessboard(); // See https://stackoverflow.com/questions/16750772/instantiating-interfaces-in-java
  ...
  ViewControl (Boardgame gm, int n) {
    ...
    thePanel.setLayout(new GridLayout(this.size, this.size));
    f.add(thePanel);
